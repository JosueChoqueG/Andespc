...
@section('title', 'Historial de Mantenimientos Térmicos')
@section('header', 'Estadísticas de Mantenimiento Térmico')
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">
                        <i class="bi bi-chart-line"></i> Estadísticas de la Impresora Térmica
                    </h3>
                    <div class="card-tools">
                        <a href="{{ route('admin.termicas.show', $termica->id) }}" class="btn btn-default btn-sm">
