...
@section('title', 'Detalle de Mantenimiento Térmico')
            ...
            <div class="card">  
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{ route('admin.termicas.hoja-vida-mantenimiento', $mantenimiento->id) }}" class="btn btn-info btn-sm">
                            <i class="bi bi-file-earmark-text"></i> Hoja de Vida
                        </a>
                        <a href="{{ route('admin.termicas.hoja-vida-mantenimiento.pdf', $mantenimiento->id) }}" class="btn btn-danger btn-sm">
                            <i class="bi bi-file-pdf"></i> PDF
                        </a>
                        <a href="{{ route('admin.termicas.show', $mantenimiento->termica_id) }}" class="btn btn-default btn-sm">
                            <i class="bi bi-printer"></i> Ver Impresora
                        </a>
                        <a href="{{ route('admin.mantenimientos-termica.edit', $mantenimiento->id) }}" class="btn btn-warning btn-sm">
                ...
                <div class="card-body">
                        ...
                        <div class="col-md-6">
                            <div class="info-box bg-light">
                                <div class="info-box-content">
                                    <span class="info-box-text text-muted">Impresora Térmica</span>
                                    <span class="info-box-number">
                                        {{ $mantenimiento->termica->marca_termica }} 
                                        {{ $mantenimiento->termica->modelo_termica }}
                                    </span>
                                    <small>Serie: {{ $mantenimiento->termica->serie_termica }}</small>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="card mt-3">
                        <div class="card-header bg-info text-white">
                            <h5 class="card-title mb-0 text-white">Descripción del Mantenimiento</h5>
                        </div>
                        <div class="card-body">
                    ...
                    <div class="card mt-3">
                        <div class="card-header bg-secondary text-white">
                            <h5 class="card-title mb-0 text-white">Observaciones del Mantenimiento</h5>
                        </div>
                        <div class="card-body">
                            <p class="card-text" style="white-space: pre-line;">
                    ...
                    <div class="card mt-3 border-danger">
                        <div class="card-header bg-danger text-white">
                            <h5 class="card-title mb-0 text-white">
                                <i class="fas fa-exclamation-triangle text-white"></i> Fallas Detectadas
                            </h5>
                        </div>
                        <div class="card-body">
                            <p class="card-text" style="white-space: pre-line;">
                    ...
                    <div class="card mt-3 border-success">
                        <div class="card-header bg-success text-white">
                            <h5 class="card-title mb-0 text-white">
                                <i class="fas fa-check-circle text-white"></i> Solución Aplicada
                            </h5>
                        </div>
                        <div class="card-body">
                            <p class="card-text" style="white-space: pre-line;">
