...
@section('title', 'Editar Mantenimiento Térmico')
@section('header', 'Editar Mantenimiento de Impresora Térmica')
    ...
    <div class="row">
        <div class="col-md-10 offset-md-1">
            <div class="card">
                ...
                <form action="{{ route('admin.mantenimientos-termica.update', $mantenimiento->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <input type="hidden" name="termica_id" value="{{ $mantenimiento->termica_id }}">
                    <div class="card-body">
                        <div class="alert alert-info">
                            <i class="fas fa-info-circle"></i> 
                            Impresora Térmica: <strong>{{ $mantenimiento->termica->marca_termica }} {{ $mantenimiento->termica->modelo_termica }}</strong>
                            (Serie: {{ $mantenimiento->termica->serie_termica }})
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="fecha_mantenimiento" 
                                           ...
                                           value="{{ old('fecha_mantenimiento', is_string($mantenimiento->fecha_mantenimiento) ? $mantenimiento->fecha_mantenimiento : ($mantenimiento->fecha_mantenimiento ? $mantenimiento->fecha_mantenimiento->format('Y-m-d') : '')) }}" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="fecha_fallas" 
                                           ...
                                           value="{{ old('fecha_fallas', is_string($mantenimiento->fecha_fallas) ? $mantenimiento->fecha_fallas : ($mantenimiento->fecha_fallas ? $mantenimiento->fecha_fallas->format('Y-m-d') : '')) }}">
                                    @error('fecha_fallas')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
