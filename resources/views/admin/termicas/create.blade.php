...
@section('title', 'Nueva Impresora Térmica')
@section('header', 'Registrar Impresora Térmica')
        ...
        <div class="col-md-8 offset-md-2">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">
                        <i class="bi bi-plus-circle"></i> Datos de la Impresora Térmica
                    </h3>
                ...
                <form action="{{ route('admin.termicas.store') }}" method="POST">
                    @csrf
                    <div class="card-body">
                        @if ($errors->any())
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="marca_termica" class="form-control @error('marca_termica') is-invalid @enderror" 
                                        value="{{ old('marca_termica', 'Epson') }}" placeholder="ej: Epson, Bixolon, 3nStar" required>
                                    @error('marca_termica')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="serie_termica" class="form-control @error('serie_termica') is-invalid @enderror" 
                                           value="{{ old('serie_termica') }}" placeholder="Número de serie único" required>
                                    @error('serie_termica')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="tipo_conexion" class="form-control @error('tipo_conexion') is-invalid @enderror">
                                        ...
                                        <option value="SERIAL" {{ old('tipo_conexion') == 'SERIAL' ? 'selected' : '' }}>Serial</option>
                                        <option value="WI-FI" {{ old('tipo_conexion') == 'WI-FI' ? 'selected' : '' }}>Wi-Fi</option>
                                        <option value="BLUETOOTH" {{ old('tipo_conexion') == 'BLUETOOTH' ? 'selected' : '' }}>Bluetooth</option>
                                    </select>
                                    @error('tipo_conexion')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nombre_host" class="form-control @error('nombre_host') is-invalid @enderror" 
                                           value="{{ old('nombre_host') }}" placeholder="ej: TERMICA-POS-01">
                                    @error('nombre_host')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="direccion_ip" class="form-control @error('direccion_ip') is-invalid @enderror" 
                                           value="{{ old('direccion_ip') }}" placeholder="192.168.1.150">
                                    @error('direccion_ip')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="estado_termica" class="form-control @error('estado_termica') is-invalid @enderror">
                                        <option value="OPTIMO" {{ old('estado_termica') == 'OPTIMO' ? 'selected' : '' }}>Óptimo</option>
                                        <option value="BUENO" {{ old('estado_termica') == 'BUENO' ? 'selected' : '' }}>Bueno</option>
                                        <option value="REGULAR" {{ old('estado_termica') == 'REGULAR' ? 'selected' : '' }}>Regular</option>
                                        <option value="DEFICIENTE" {{ old('estado_termica') == 'DEFICIENTE' ? 'selected' : '' }}>Deficiente</option>
                                        <option value="DE BAJA" {{ old('estado_termica') == 'DE BAJA' ? 'selected' : '' }}>De Baja</option>
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="velocidad_impresion" class="form-control @error('velocidad_impresion') is-invalid @enderror" 
                                           value="{{ old('velocidad_impresion') }}" placeholder="ej: 250 mm/s">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="modelo_consumible" class="form-control @error('modelo_consumible') is-invalid @enderror" 
                                           value="{{ old('modelo_consumible') }}" placeholder="ej: Rollo Térmico 80mm">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="tipo_consumible" class="form-control @error('tipo_consumible') is-invalid @enderror" 
                                           value="{{ old('tipo_consumible', 'Papel Térmico') }}" placeholder="ej: Papel Térmico">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="capacidad_impresion" class="form-control @error('capacidad_impresion') is-invalid @enderror" 
                                           value="{{ old('capacidad_impresion') }}" placeholder="ej: 150">
                    ...
                    <div class="card-footer text-right">
                        ...
                        <button type="submit" class="btn btn-primary">
                            <i class="fas fa-save"></i> Guardar Térmica
                        </button>
                    </div>
                </form>
            </div>
