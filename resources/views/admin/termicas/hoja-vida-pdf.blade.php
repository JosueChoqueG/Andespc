        ...
        <div class="page">
            ...
            <table>
                <tr>
                    ...
                    <td style="width: 20%;" class="text-center">{{ $termica->marca_termica }}</td>
                    <th style="width: 10%;">Modelo</th>
                    <td class="text-center" >{{ $termica->modelo_termica }}</td>
                </tr>
                <tr>
                    <th style="width: 15%;">Fecha Adquisición</th>
                    <td style="width: 12%;" class="text-center">{{ $termica->fecha_adquisicion ? $termica->fecha_adquisicion->format('d/m/Y') : 'N/A' }}</td>
                ...
                <tr>
                    ...
                    <td style="width: 12%;" class="text-center">{{ $termica->serie_termica }}</td>
            ...
            <table>
                <tr>
                    ...
                    <td style="width: 40%;" class="text-center">
                        {{ $termica->responsable->nombre_responsable ?? 'N/A' }}
                    </td>
                </tr>
            </table>
            ...
            <table>
                <tr>
                    ...
                    <td style="width: 20%;" class="text-center">{{ $termica->tipo_conexion }}</td>
                    <th style="width: 10%;">Direcion IP</th>
                    <td class="text-center">{{ $termica->direccion_ip ?? 'N/A' }}</td>
                </tr>
                <tr>
                    <th width="15%">Velocidad impresion</th>
                    <td width="20%" class="text-center">{{ $termica->velocidad_impresion ?? 'N/A' }}</td>
                    <th width="15%">Cantidad impresion</th>
                    <td width="20%" class="text-center">{{ number_format($termica->cantidad_impresion ?? 0) }} m/cortes</td>
                    <th width="10%">Tipo consumible</th>
                    <td class="text-center">{{ $termica->tipo_consumible ?? 'N/A' }}</td>
                </tr>
                <tr>
                    <th width="15%">Modelo consumible</th>
                    <td width="20%" class="text-center">{{ $termica->modelo_consumible ?? 'N/A' }}</td>
                    <th width="15%">Capacidad útil (Km)</th>
                    <td width="20%" class="text-center">{{ $termica->capacidad_impresion ? number_format($termica->capacidad_impresion) . ' Km' : 'N/A' }}</td>
                    <th width="10%">-</th>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        @foreach($estados as $key => $label)
                            [ {{ $termica->estado_termica == $key ? 'X' : ' ' }} ]<br>
                        @endforeach
                    </td>
                    <td>
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $termica->responsable->nombre_responsable ?? 'N/A' }}</td>
                            <td>Usuario de Oficina {{ $termica->oficina->nombre_oficina ?? '' }}</td>
                            <td></td>
                        </tr>
                    </tbody>
                </table>
