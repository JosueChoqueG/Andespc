...
class MantenimientoContabillete extends Model
{
    use HasFactory;

    protected $table = 'mantenimiento_contabillete';
    ...
    // Relaciones
    public function contabillete(): BelongsTo
    {
        return $this->belongsTo(Contabillete::class, 'contabillete_id');
    }
